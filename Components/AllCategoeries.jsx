        ...
        <>
            <div className="w-full max-w-7xl">
                <div className='text-center'>
                    <p className='text-[25px] text-customPink mt-10' >All Categories</p>
                            ...
                            <div className="p-3">
                                <div className="flex items-center justify-between w-full  mb-auto ">
                                    <div className="flex items-center">
                                        <div className="pr-3 p-5">
                                            <Image className="object-cover w-[100px] h-[100px] rounded-full " src="/pp.png" alt="" width={100} height={100} />
                                        </div>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex flex-1">
                                            <div className="">
                                                ...
                                                <p className="text-lg text-gray-500">Reacok t Tutorials for Beginner</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
